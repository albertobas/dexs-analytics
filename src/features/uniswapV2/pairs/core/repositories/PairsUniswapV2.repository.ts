...
interface PairsUniswapV2Repository {
  getByBlocks(endpoint: string, blocks: Blocks): Promise<PairsUniswapV2 | undefined>; //: Promise<{ loading: boolean | null; error: ApolloError | undefined; data: PoolDataCollection[] | undefined }>;
}
